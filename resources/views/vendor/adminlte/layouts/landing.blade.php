    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>SSRC</b></a>
            </div>
        ...
        <div id="headerwrap">
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        <h1>SSRC <b><a href="https://github.com/acacha/adminlte-laravel"></a></b></h1>
                        <h3><a href="https://laravel.com/">Sistema de Solicitud de Recursos Computacionales</a> </h3>
                    </div>
                    <!--div class="col-lg-2">
