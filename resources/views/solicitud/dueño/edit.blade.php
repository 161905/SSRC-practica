    ...
    <div class="container-fluid spark-screen">
        <div class="row">
            ...
            <div class="panel-body">
                ...
                <form  action="{{route('solicitud.dueño.update',$solis->numSol)}}" method="POST">
                    {!!method_field('PUT')!!}
                    {!!csrf_field()!!}
                    <textarea style="width: 424px; height: 100px;" name="mensaje" value="mensaje" placeholder="Ingrese nota de dueño antes de enviar"></textarea>
                    <br>
                         ...
                         <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    ¿Seguro desea aceptar la solicitud?
                  ...
                  <a type="button" class="btn btn-primary" href="../../../../solicitud/dueño/index">Volver</a>
                </form>  
            </div>
            </div>
            </div>
