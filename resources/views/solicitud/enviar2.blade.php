              ...
              <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="myTable">
                        ...
                        <form  action="{{route('solicitud.enviar2.update',$solis->numSol)}}" method="POST">
                        {!!method_field('PUT')!!}
                        {!!csrf_field()!!}
                             ...
                             <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        ¿Seguro desea enviar esta solicitud?
                                     </div>
                      ...
                      <a type="button" class="btn btn-success" data-toggle="modal" data-target="#confirmar">Enviar solicitud</a>
                      <a type="button" class="btn btn-warning" href="/solicitud/editar/{{$solis->numSol}}">Editar</a>
                      <a type="button" class="btn btn-primary" href="/solicitud/enviar">Volver</a>
                    </form>  
                            ...
                            <tbody>   
                                ...
                                foreach ($subrecs as $sub) {
                                    foreach ($SolSub as $ss) {
                                        if($sub->idDueño == NULL && $sub->subrecid == $ss->subrecid){
                                            echo"
                                            <tr>
                                            ...
                                            foreach ($userrs as $us) {
                                                if($sub->idDueño == $us->id && $sub->subrecid == $ss->subrecid){
                                                    echo"
                                                    <tr>
