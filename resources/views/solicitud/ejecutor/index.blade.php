    ...
    <div class="row">
      <!--div class="col-md-9 col-md-offset-1"-->
        <div class="col-12">
                    ...
                    <br><br>
                    <button style="width: 200px" class="myButton2" onclick="pendientes('PENDIENTE DE EJECUCION')">Solicitudes pendientes</button>
                    <button style="width: 200px" class="myButton4" onclick="hora()">Solicitudes hoy</button>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="myTable">
                                 ...
                                 <tbody > 
                                      ...
                                      <tr>
                                        <td>
                                          @if($sol->Estado == 'PENDIENTE DE EJECUCION')
                                          <a class="myButton" href="../ejecutor/edit/{{$sol->numSol}}/">{{$sol->numSol}}</a>
                                          @else    


                                          <a class="myButton" href="../ejecutor/edit2/{{$sol->numSol}}/">{{$sol->numSol}}</a>
                                          @endif
