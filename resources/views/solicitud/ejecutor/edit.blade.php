    ...
    <div class="container-fluid spark-screen">
        <div class="row">
            ...
            <div class="panel-body">
                ...
                <form  action="{{route('solicitud.ejecutor.update',$solis->numSol)}}" method="POST">
                    {!!method_field('PUT')!!}
                    {!!csrf_field()!!}
                    <textarea style="width: 424px; height: 100px;" name="Nota_Ejecutor" value="Nota_Ejecutor" placeholder="Ingrese nota de Ejecutor antes de enviar"></textarea>
                    <br>
                         ...
                         <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    ¿Seguro desea rechazar la solicitud?
                                 </div>
                    ...
                    <div class="modal fade" id="confirmar2" tabindex="" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                         <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                ...
                                <div class="modal-body">
                                    ...
                                    ¿Seguro desea ejecutar la solicitud?
                                    Ingrese ticket GSD si lo requiere:
                                    <br>
                                    <input type="text" name="ticketGSD">

                                 </div>

                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-success" name="aceptar" value="aceptar">Aceptar</button>
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                                </div>
                  ...
                  <a type="button" class="btn btn-success" data-toggle="modal" data-target="#confirmar2">Aceptar</a>

                  <a type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirmar">Rechazar</a>

                  <a type="button" class="btn btn-primary" href="../../../../solicitud/ejecutor/index">Volver</a>
                </form>  
            </div>
            </div>
            </div>
