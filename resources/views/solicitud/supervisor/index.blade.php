                    ...
                    <button style="width: 200px" class="myButton4" onclick="hora()">Solicitudes hoy</button>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="myTable">
                                  ...
                                  <tbody > 
                                      ...
                                      @if($sol->idSupervisor == $user->id)

                                      <tr>
                                        <td>
                                          @if($sol->Estado == "PENDIENTE DE SUPERVISOR")
                                          <a class="myButton" href="../supervisor/edit/{{$sol->numSol}}/">{{$sol->numSol}}</a>
                                          @else
                                          <a class="myButton" href="../supervisor/edit2/{{$sol->numSol}}/">{{$sol->numSol}}</a>
                                          @endif
