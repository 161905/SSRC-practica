            ...
            <div class="panel-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="myTable">
                      ...
                      <tbody>   
                          ...
                          <tr>
                            <th scope="row">Contrato/Porcion</th>
                            <td>(Info. del AD)</td>
                          </tr>
                          <tr>
                ...
                <form  action="{{route('solicitud.supervisor.update',$solis->numSol)}}" method="POST">
                    {!!method_field('PUT')!!}
                    {!!csrf_field()!!}
                    <textarea style="width: 424px; height: 100px;" name="Nota_Supervisor" value="Nota_Supervisor" placeholder="Ingrese nota de supervisor antes de enviar"></textarea>
                    <br>
