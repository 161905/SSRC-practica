            ...
            <div class="col-md-4">
              <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form  action="{{route('solicitud.ss2.update',$solis->numSol)}}" method="POST">
                        {!!method_field('PUT')!!}
                        {!!csrf_field()!!}
                        <textarea style="width: 424px; height: 100px;" name="Nota_Sol" value="Nota_Sol" placeholder="Envie una nueva nota..."></textarea>
                        <br>
                      ...
                      <a type="button" class="btn btn-primary" href="/solicitud/solicitudessolicitadas">Volver</a>
                    </form>  
                </div>
              </div>
            </div>
